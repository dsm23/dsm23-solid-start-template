  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "animate-content-hide data-[expanded]:animate-content-show z-50 min-w-32 origin-top overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md",
          props.class,
        )}
        {...rest}
      />
...
const DropdownMenuSubContent = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      class={cn(
        "z-50 min-w-32 origin-top animate-in overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md",
        props.class,
      )}
      {...rest}
    />
