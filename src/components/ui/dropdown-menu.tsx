  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        class={cn(
          "animate-content-hide bg-popover text-popover-foreground data-[expanded]:animate-content-show z-50 min-w-32 origin-top overflow-hidden rounded-md border p-1 shadow-md",
          props.class,
        )}
        {...rest}
      />
...
const DropdownMenuSubContent = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      class={cn(
        "bg-popover text-popover-foreground animate-in z-50 min-w-32 origin-top overflow-hidden rounded-md border p-1 shadow-md",
        props.class,
      )}
      {...rest}
    />
